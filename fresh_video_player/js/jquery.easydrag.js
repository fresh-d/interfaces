...
*
* 2012.12.29 - adding optional only X or Y position
* fedo - studio-fresh
*/
	...
	$.fn.easydrag = function(options){
		...
		return this.each(function(){
			...
			$(this).mousedown(function(e){
				...
				var pos    = $.getMousePosition(e);
				if(options.allowXmove) lastMouseX = pos.x;
				if(options.allowYmove) lastMouseY = pos.y;
				...
				return options.allowBubbling ? true : false;
			});
		});
	};
